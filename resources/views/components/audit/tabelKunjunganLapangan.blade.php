                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="p-4">
                            <div class="flex justify-center gap-3">
                                ...
                                <a href="{{ asset(str_starts_with($k->path_file_kunjungan, 'storage/') ? $k->path_file_kunjungan : 'storage/' . $k->path_file_kunjungan) }}" target="_blank" class="text-blue-600 hover:scale-110 transition" title="Lihat File">
