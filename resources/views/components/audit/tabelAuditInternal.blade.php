<div class="p-2">
    ...
    <div class="bg-white rounded-2xl shadow-sm p-3 sm:p-4 border border-gray-200">
        <div class="overflow-x-auto">
            <table id="auditTable" class="w-full text-left border-collapse display responsive nowrap">
                <thead>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="p-4">
                            <div class="flex justify-center gap-3">
                                ...
                                <a href="{{ asset('storage/' . $a->path_file_kunjungan) }}" target="_blank" class="text-blue-600 hover:scale-110 transition" title="Lihat File">
