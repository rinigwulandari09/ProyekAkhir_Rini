    ...
    <div class="flex h-full w-full relative">
        ...
        <aside class="bg-[#234323] text-white flex flex-col shrink-0 h-full fixed md:static z-50 transition-all duration-300"
            ...
            <nav class="flex-1 p-3 space-y-1.5 mt-4 text-sm overflow-y-auto">
                ...
                <a href="{{ route('user.index') }}" class="flex items-center gap-3 p-3 rounded-xl transition {{ request()->routeIs('user.*') ? 'bg-[#D4AF37] text-[#234323] font-bold shadow-sm' : 'text-white/85 hover:text-white hover:bg-white/10' }}" :class="!sidebarOpen && 'justify-center'">
