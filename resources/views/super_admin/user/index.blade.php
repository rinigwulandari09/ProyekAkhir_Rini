...
<div class="p-2">
    ...
    <div class="bg-white rounded-2xl shadow-sm p-3 sm:p-4 border border-gray-200">
        <table id="userTable" class="w-full text-left border-collapse display responsive nowrap" style="width: 100%">
            <thead>
                <tr class="bg-[#D4AF37] border-b border-[#B8860B] shadow-sm text-black">
                    ...
                    <th class="p-4 text-xs font-extrabold uppercase text-left tracking-wider">Desa Tugas</th>
                    <th class="p-4 text-xs font-extrabold uppercase text-center tracking-wider">Role</th>
...
<style>
    ...
    #userTable th, #userTable td { white-space: nowrap !important; }
